    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <div className="space-y-2 text-gray-300">
              <p className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-accent-teal" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="flex items-start">
                <svg className="w-5 h-5 mr-2 mt-1 text-accent-teal" fill="currentColor" viewBox="0 0 20 20">
          ...
          >
            <h4 className="text-lg font-semibold mb-4 text-accent-teal">Our Services</h4>
          ...
          >
            <h4 className="text-lg font-semibold mb-4 text-accent-teal">Service Areas</h4>
            <div className="grid grid-cols-2 gap-1 text-sm text-gray-300">
              {serviceAreas.map((area, index) => (
                <div key={index} className="hover:text-accent-teal transition-colors cursor-pointer">
                  {area}
                </div>
              ))}
            </div>
          ...
          >
            ...
            <ul className="space-y-2 mb-6">
              <li><Link href="/about" className="text-gray-300 hover:text-accent-teal transition-colors">About Us</Link></li>
              <li><Link href="/gallery" className="text-gray-300 hover:text-accent-teal transition-colors">Portfolio</Link></li>
              <li><Link href="/quote" className="text-gray-300 hover:text-accent-teal transition-colors">Free Estimate</Link></li>
              <li><Link href="/contact" className="text-gray-300 hover:text-accent-teal transition-colors">Contact</Link></li>
            </ul>
            
            <h5 className="text-sm font-semibold mb-3 text-accent-teal">Follow Us</h5>
            <div className="flex space-x-4">
              {/* Facebook */}
              <a href="#" className="text-gray-300 hover:text-accent-teal transition-colors">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-4 text-sm">
            <Link href="/privacy" className="hover:text-accent-teal transition-colors">Privacy Policy</Link>
            <span>•</span>
            <Link href="/terms" className="hover:text-accent-teal transition-colors">Terms of Service</Link>
            <span>•</span>
            <Link href="/sitemap" className="hover:text-accent-teal transition-colors">Sitemap</Link>
          </div>
        </motion.div>
      </div>
    </footer>
